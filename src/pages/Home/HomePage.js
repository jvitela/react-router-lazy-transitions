        ...
        <div className="max-w-3xl mx-auto flex p-6 bg-white rounded-lg shadow mt-4">
          ...
          <div className="pt-1">
            ...
            <p className="text-base text-gray-600 leading-normal mb-2">
              This is a demo of React-Router v5 with enhanced page transitions
              and code splitting.
              <br />
            ...
            <p className="text-base text-gray-600 leading-normal mb-2">
              ...
              links will be injected to the page component as a{" "}
              <code>links</code> property. The page will also receive a{" "}
              <code>history</code> property in order to make imperative
              navigations.
            </p>
            <p className="text-base text-gray-600 leading-normal mb-2">
